...
/**
 * Página de edição de responsabilidade
 * Módulo Secretaria - Etapa 3
 *
 * Esta página permite editar uma responsabilidade existente no sistema.
 * A Secretaria pode atualizar dados da responsabilidade.
 */
...
const form = useForm({
    minor_person_id: props.guardianship.minor_person_id,
    guardian_person_id: props.guardianship.guardian_person_id,
    relationship_type: props.guardianship.relationship_type,
    is_legal_guardian: props.guardianship.is_legal_guardian,
    is_financial_responsible: props.guardianship.is_financial_responsible,
    can_authorize_login: props.guardianship.can_authorize_login,
    can_approve_changes: props.guardianship.can_approve_changes,
    can_view_financial: props.guardianship.can_view_financial,
    can_receive_canteen_debts: props.guardianship.can_receive_canteen_debts,
    starts_at: props.guardianship.starts_at || '',
    ends_at: props.guardianship.ends_at || '',
    status: props.guardianship.status,
    notes: props.guardianship.notes || ''
});

const submit = () => {
    form.put(route('guardianships.update', props.guardianship.id));
};
...
<template>
    <Head title="Editar Responsabilidade" />
