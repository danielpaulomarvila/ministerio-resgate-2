...
/**
 * Página de edição de família
 * Módulo Secretaria - Etapa 2
 *
 * Esta página permite editar uma família existente no sistema.
 * A Secretaria pode atualizar nome, descrição, responsável principal,
...
const form = useForm({
    ...
    responsible_person_id: props.family.responsible_person_id || null,
    status: props.family.status,
