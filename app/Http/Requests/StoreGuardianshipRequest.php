...
/**
 * Request para validação de criação de responsabilidade
 * Módulo Secretaria - Etapa 3
 *
 * Valida os dados enviados ao criar uma nova responsabilidade sobre menor,
 * garantindo que as regras de negócio sejam respeitadas.
 */
class StoreGuardianshipRequest extends FormRequest
{
    /**
     * Determine if the user is authorized to make this request.
     *
     * Apenas usuários autenticados podem criar responsabilidades.
     *
     * @return bool
     */
     ...
     * - Não permitir duplicidade exata ativa
     *
    ...
    public function withValidator($validator)
    {
        $validator->after(function ($validator) {
            ...
            // Verificar duplicidade exata ativa
