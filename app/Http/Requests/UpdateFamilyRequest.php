...
/**
 * Request para validação de atualização de família
 * Módulo Secretaria - Etapa 2
 *
 * Valida os dados enviados ao atualizar uma família existente,
...
class UpdateFamilyRequest extends FormRequest
{
     ...
     *
     * Apenas usuários autenticados podem atualizar famílias.
     *
     * @return bool
     */
